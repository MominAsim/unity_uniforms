...
return (
 <>
    ...
    <body>
      ...
      <br></br>
      <img className="image_product_secondpage" src="/images/products/Sports_pant.jpg" alt="Shirt pic" />
      <h1 className="product_name_second_page">Sports Trousers</h1>
      <p>Sports trousers for sports wear</p>
