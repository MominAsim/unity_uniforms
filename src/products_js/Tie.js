...
return (
 <>
    ...
    <body>
      ...
      <br></br>
      <img className="image_product_secondpage" src="/images/products/tie.jpg" alt="Shirt pic" />
      <h1 className="product_name_second_page">Tie</h1>
      <p>Tie for formal wear, part of boys uniform</p>
      <h2 className="price_product_second_page">RS 600</h2>
