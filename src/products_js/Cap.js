...
return (
 <>
    ...
    <body>
      ...
      <br></br>
      <img className="image_product_secondpage" src="/images/products/cap.jpg" alt="Shirt pic" />
      <h1 className="product_name_second_page">Sports Cap</h1>
      <p>Unisex Red Cap for sports wear</p>
